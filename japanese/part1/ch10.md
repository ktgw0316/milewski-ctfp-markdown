...
\noindent
2つの圏$\cat{C}$と$\cat{D}$の間のHom集合の代わりにHom圏――関手圏$\cat{D^C}$がある。通常の関手合成があり、$\cat{D^C}$からの関手$F$は$\cat{E^D}$からの関手$G$と合成して$\cat{E^C}$からの関手$G \circ F$を与える。さらに、それぞれのHom圏内での合成もある――関手間での自然変換（すなわち2本の射）の垂直合成だ。
