...
You know that this is not a pure function, because its memoized version would fail to produce a log. This function has [side effects]{.keyword #side_effect}.
