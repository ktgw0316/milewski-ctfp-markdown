...
This is Haskell for $1 + a \times{}a$ (remember [algebraic data structures](https://bartoszmilewski.com/2015/01/13/simple-algebraic-data-types/)).
...
Applying an endofunctor infinitely many times produces a [fixed point]{id="fixed_point"}, an object defined as:
...
To complete the picture, we have to define morphisms in the category of F-algebras. A morphism must map one algebra $(a, f)$ to another algebra $(b, g)$. We'll define it as a morphism $m$ that maps the carriers --- it goes from $a$ to $b$ in the original category. Not any morphism will do: we want it to be compatible with the two evaluators. (We call such a structure-preserving morphism a [homomorphism]{id="homomorphism"}.) Here's how you define a homomorphism of F-algebras. First, notice that we can lift $m$ to the mapping:
