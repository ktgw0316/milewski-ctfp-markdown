...
\noindent
We can now proceed with the universal construction and define the end of $p$ as the universal wedge --- a set $e$ together with a family of functions $\pi$ such that for any other wedge with the apex $e'$ and a family $\alpha$ there is a unique function $h \Colon e' \to e$ that makes all triangles commute:
$$\pi_a \circ h = \alpha_a$$
