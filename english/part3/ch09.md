...
If the lens also satisfies PUTPUT, it is called a very well behaved lens. So, in other words, a well-behaved lens is indeed a comonad coalgebra for the `Store` functor.
